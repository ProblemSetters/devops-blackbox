...
. /blackbox/blackbox puppet check "test"
...
cat <<ASSERT | blackbox.expect.shell.success % {%s,%s,"manifest.pp"}
set -o errexit
{
  test -f /home/ubuntu/test/solve.assert
}
...
cat <<ASSERT | blackbox.expect.shell.success % {%s,%s,"Puppetfile"}
set -o errexit
{
  test -f /home/ubuntu/test/solve.assert
}
...
cat <<ASSERT | blackbox.expect.shell.success % {%s,%s,"r10k binary"}
set -o errexit
{
  test -f /home/ubuntu/test/solve.assert
}
...
cat <<ASSERT | blackbox.expect.shell.success % {%s,%s,"puppet binary"}
set -o errexit
{
  test -f /home/ubuntu/test/solve.assert
}
