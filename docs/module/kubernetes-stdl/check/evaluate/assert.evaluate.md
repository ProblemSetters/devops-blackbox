# module/kubernetes-stdl/check/evaluate/assert.evaluate

https://github.com/ProblemSetters/devops-blackbox/blob/2404/module/kubernetes-stdl/check/evaluate/assert.evaluate
